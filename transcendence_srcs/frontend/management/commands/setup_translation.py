...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		TranslateList = [
			...
			{'Key': 'Notifs_btn', 'Lang': 'fr', 'Text': 'Notifications'},
			{'Key': 'Notifs_btn', 'Lang': 'en', 'Text': 'Notifications'},
			{'Key': 'Notifs_btn', 'Lang': 'es', 'Text': 'Notificaciones'},
			{'Key': 'Send_btn', 'Lang': 'fr', 'Text': 'Envoyer'},
			{'Key': 'Send_btn', 'Lang': 'en', 'Text': 'Send'},
			{'Key': 'Send_btn', 'Lang': 'es', 'Text': 'Enviar'},
			{'Key': 'Invite_play_btn', 'Lang': 'fr', 'Text': 'Inviter à jouer'},
			{'Key': 'Invite_play_btn', 'Lang': 'en', 'Text': 'Invite to play'},
			{'Key': 'Invite_play_btn', 'Lang': 'es', 'Text': 'Invitar a jugar'},
			{'Key': 'Matchmaking_btn', 'Lang': 'fr', 'Text': 'Rechercher un joueur'},
			{'Key': 'Matchmaking_btn', 'Lang': 'en', 'Text': 'Search for player'},
			{'Key': 'Matchmaking_btn', 'Lang': 'es', 'Text': 'Buscar un jugador'},
			{'Key': 'Delete_btn', 'Lang': 'fr', 'Text': 'Supprimer'},
			{'Key': 'Delete_btn', 'Lang': 'en', 'Text': 'Delete'},
			{'Key': 'Delete_btn', 'Lang': 'es', 'Text': 'Borrar'},
			{'Key': 'Block_btn', 'Lang': 'fr', 'Text': 'Bloquer'},
			{'Key': 'Block_btn', 'Lang': 'en', 'Text': 'Block'},
			{'Key': 'Block_btn', 'Lang': 'es', 'Text': 'Bloquear'},
			{'Key': 'Unblock_btn', 'Lang': 'fr', 'Text': 'Déloquer'},
			{'Key': 'Unblock_btn', 'Lang': 'en', 'Text': 'Unblock'},
			{'Key': 'Unblock_btn', 'Lang': 'es', 'Text': 'Desbloquear'},
			{'Key': 'Warning_title', 'Lang': 'fr', 'Text': 'Avertissement'},
			{'Key': 'Warning_title', 'Lang': 'en', 'Text': 'Warning'},
			{'Key': 'Warning_title', 'Lang': 'es', 'Text': 'Advertencia'},
			{'Key': 'Delete_friend_mess', 'Lang': 'fr', 'Text': 'Vous êtes sur le point de supprimer votre ami(e) !'},
			{'Key': 'Delete_friend_mess', 'Lang': 'en', 'Text': 'You are about to delete your friend !'},
			{'Key': 'Delete_friend_mess', 'Lang': 'es', 'Text': '¡ Estás a punto de borrar a tu amigo(a) !'},
			{'Key': 'Sure_question', 'Lang': 'fr', 'Text': 'Êtes vous sûr ?'},
			{'Key': 'Sure_question', 'Lang': 'en', 'Text': 'Are you sure ?'},
			{'Key': 'Sure_question', 'Lang': 'es', 'Text': '¿ Está seguro ?'},
			{'Key': 'Yes_answer', 'Lang': 'fr', 'Text': 'Oui'},
			{'Key': 'Yes_answer', 'Lang': 'en', 'Text': 'Yes'},
			{'Key': 'Yes_answer', 'Lang': 'es', 'Text': 'Si'},
			{'Key': 'No_answer', 'Lang': 'fr', 'Text': 'Non'},
			{'Key': 'No_answer', 'Lang': 'en', 'Text': 'No'},
			{'Key': 'No_answer', 'Lang': 'es', 'Text': 'No'},
			{'Key': 'Block_friend_mess', 'Lang': 'fr', 'Text': 'Vous êtes sur le point de bloquer votre ami(e) !'},
			{'Key': 'Block_friend_mess', 'Lang': 'en', 'Text': 'You are about to block your friend !'},
			{'Key': 'Block_friend_mess', 'Lang': 'es', 'Text': '¡ Estás a punto de bloquear a tu amigo(a) !'},
			{'Key': 'Close_btn', 'Lang': 'fr', 'Text': 'Fermer'},
			{'Key': 'Close_btn', 'Lang': 'en', 'Text': 'Close'},
			{'Key': 'Close_btn', 'Lang': 'es', 'Text': 'Cerrar'},
			{'Key': 'Invitation_title', 'Lang': 'fr', 'Text': 'Invitation !'},
			{'Key': 'Invitation_title', 'Lang': 'en', 'Text': 'Invitation !'},
			{'Key': 'Invitation_title', 'Lang': 'es', 'Text': '¡ Invitación !'},
			{'Key': 'Invite_mess', 'Lang': 'fr', 'Text': ' vous invite à jouer !'},
			{'Key': 'Invite_mess', 'Lang': 'en', 'Text': ' invites you to play !'},
			{'Key': 'Invite_mess', 'Lang': 'es', 'Text': ' te invita a jugar !'},
