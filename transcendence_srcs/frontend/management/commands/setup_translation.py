...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		TranslateList = [
			...
			{'Key': 'Player_vs_Player', 'Lang': 'fr', 'Text': 'Joueur vs Joueur'},
			{'Key': 'Player_vs_Player', 'Lang': 'en', 'Text': 'Player vs Player'},
			{'Key': 'Player_vs_Player', 'Lang': 'es', 'Text': 'Jugador vs Jugador'},
			{'Key': 'Player_vs_AI', 'Lang': 'fr', 'Text': 'Joueur vs IA'},
			{'Key': 'Player_vs_AI', 'Lang': 'en', 'Text': 'Player vs AI'},
			{'Key': 'Player_vs_AI', 'Lang': 'es', 'Text': 'Jugador vs IA'},
			{'Key': 'Difficulty_easy', 'Lang': 'fr', 'Text': 'facile'},
			{'Key': 'Difficulty_easy', 'Lang': 'en', 'Text': 'easy'},
			{'Key': 'Difficulty_easy', 'Lang': 'es', 'Text': 'fácil'},
			{'Key': 'Difficulty_medium', 'Lang': 'fr', 'Text': 'moyen'},
			{'Key': 'Difficulty_medium', 'Lang': 'en', 'Text': 'medium'},
			{'Key': 'Difficulty_medium', 'Lang': 'es', 'Text': 'medio'},
			{'Key': 'Difficulty_hard', 'Lang': 'fr', 'Text': 'difficile'},
			{'Key': 'Difficulty_hard', 'Lang': 'en', 'Text': 'hard'},
			{'Key': 'Difficulty_hard', 'Lang': 'es', 'Text': 'difícil'},
			{'Key': 'PVP_tournament', 'Lang': 'fr', 'Text': 'Tournoi'},
			{'Key': 'PVP_tournament', 'Lang': 'en', 'Text': 'Tournament'},
			{'Key': 'PVP_tournament', 'Lang': 'es', 'Text': 'Torneo'},
